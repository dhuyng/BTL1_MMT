...
class ClientApp:
    def __init__(self, root):
        ...
        self.ip_entry.insert(0, "192.168.59.1")  # Đặt giá trị mặc định hiển thị lúc start cho server IP

        self.port_label = tk.Label(root, text="Server Port:")
        self.port_entry = tk.Entry(root)
        self.port_entry.insert(0, "6789")  # Đặt giá trị mặc định hiển thị lúc start cho server port
